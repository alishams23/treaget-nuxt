      ...
      <div class="grid rtl grid-cols-2 gap-3 lg:p-6 p-4">
        <div class="col-span-2" >
          <label for="id_body" class="rtl fs-2 text-treaget irsa"
            >ارتباط با ما</label
          >
          <p tag="div" class="text-right mt-3 fs-4 text-muted">نام و نام خانوادگی</p>
          <input
            v-model="name"
            type="text"
            required
        ...
        <div class="col-span-2">
          <p class="text-right mt-3 fs-4 text-muted">توضیحات</p>
          <textarea
            name="body"
            v-model="body"
            cols="40"
        ...
        <div class="col-span-2">
          <p class="text-right mt-3 fs-4 text-muted">ایمیل</p>
          <input
            type="email"
        ...
        <div>
          <button
            type="submit"
            class="px-5 py-2  rounded-full py-2 text-white bg-treaget irsa"
          >
            <div class="fs-4" v-if="loading == false">ارسال</div>
            <div
    ...
    <div class="treaget-modal rtl" :class="modal ? 'open' : ''">
      ...
      <div class="treaget-modal-card">
        <div class="treaget-modal-body">
          <div class="treaget-modal-content fs-3">موفقیت آمیز بود</div>
